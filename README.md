...
**OllamaHome** allows you to interface locally hosted Ollama LLM's. Adds a web app across your home network with a clean and simple UI to interface. Includes a resume tailoring feature. 
...
## Installing Ollama, Models, and Resume Analyzer tools
...
You can switch between different Ollama LLM models easily without changing any code.
...
Option 1 — Change the model from the UI 
...
Please give it time to refresh.

Option 2 — Change the default model in configuration
